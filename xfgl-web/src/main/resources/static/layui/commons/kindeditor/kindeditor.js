...
//	minWidth : 650,
	...
	items : [
		...
		'insertunorderedlist', 'subscript','superscript', 'formatblock', 'fontname', 
		'fontsize', 'forecolor', 'hilitecolor', 'bold','italic', 'underline', 'fullscreen'
	],
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var _class="ke-button-common ke-button";
		if(options.isDIY){
			_class=options.diyClass;			
		}
		var html = [
			'<div class="ke-inline-block '+_class+'">',
			(options.target ? '' : '<iframe name="' + target + '" style="display:none;"></iframe>'),
			(options.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + url + '">'),
			'<span class="'+(cls?'':'ke-button-common')+'">',
			 hiddenElements.join(''),
			'<input  class="'+(cls?cls:_class)+'"  type="button" value="' + title + '" />',
			'</span>',
