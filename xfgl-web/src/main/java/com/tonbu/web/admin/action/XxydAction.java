...
import com.tonbu.web.admin.service.XxydService;
...
@Controller
@RequestMapping(value = "/xxyd")
public class XxydAction {

    Logger logger = LogManager.getLogger(XxydAction.class.getName());

    @Autowired
    HttpServletRequest request;

    @Autowired
    XxydService xxydService;

    @RequestMapping(value = "/")
    public ModelAndView home() {
        ModelAndView view = new ModelAndView("admin/manage/xxyd/list");
        return view;
    }
    ...
    public Object list() {
        ...
        Page<?> page;
        try {
            page = xxydService.loadList(param);
            r.setDataset(page);
            r.setMsg("");
    ...
    public ModelAndView add(@PathVariable(required = false) String id) {
        ModelAndView view = new ModelAndView("admin/manage/xxyd/add");
    ...
    public Object updateStatus() {
        ...
        try {
            xxydService.updateStatus(param);
            r.setMsg("修改成功");
        } catch (JSONException e) {
            r.setCode(-1);
            r.setMsg(e.getMessage());
    ...
    public Object getPageInformationList() {
        ...
        try {
            ...
            //分页查询
            Page<?> page = xxydService.getPageInformationList(type, current, rowcount);
            r.setDataset(page);
            r.setMsg("操作成功");
    ...
    public Object getPageInformationById() {
        ...
        try {
            ...
            Map<String, Object> map = xxydService.getPageInformationById(ID);
            results.add(map);
