...
import com.tonbu.web.admin.service.ZznlService;
...
@Controller
@RequestMapping(value = "/zznl")
public class ZznlAction {

    Logger logger = LogManager.getLogger(ZznlAction.class.getName());

    @Autowired
    HttpServletRequest request;

    @Autowired
    ZznlService zznlService;

    @RequestMapping(value = "/")
    public ModelAndView home() {
        ModelAndView view = new ModelAndView("admin/manage/zznl/list");
        return view;
    }
    ...
    public Object list() {
        ...
        Page<?> page;
        try {
            page = zznlService.loadList(param);
            r.setDataset(page);
            r.setMsg("");
    ...
    public ModelAndView add(@PathVariable(required = false) String id) {
        ModelAndView view = new ModelAndView("admin/manage/zznl/add");
    ...
    public Object updateStatus() {
        ...
        try {
            zznlService.updateStatus(param);
            r.setMsg("修改成功");
        } catch (JSONException e) {
            r.setCode(-1);
            r.setMsg(e.getMessage());
    ...
    public Object getPageInformationList() {
        ...
        try {
            ...
            //分页查询
            Page<?> page = zznlService.getPageInformationList(type, current, rowcount);
            r.setDataset(page);
            r.setMsg("操作成功");
    ...
    public Object getPageInformationById() {
        ...
        try {
            ...
            Map<String, Object> map = zznlService.getPageInformationById(ID);
            results.add(map);
