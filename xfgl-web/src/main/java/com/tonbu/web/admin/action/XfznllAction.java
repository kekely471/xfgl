...
import com.tonbu.web.admin.service.XfznlService;
...
@Controller
@RequestMapping(value = "/xfznl")
public class XfznllAction {

    Logger logger = LogManager.getLogger(XfznllAction.class.getName());

    @Autowired
    HttpServletRequest request;

    @Autowired
    XfznlService xfznlService;

    @RequestMapping(value = "/")
    public ModelAndView home() {
        ModelAndView view = new ModelAndView("admin/manage/xfznl/list");
        return view;
    }
    ...
    public Object list() {
        ...
        Page<?> page;
        try {
            page =xfznlService.loadList(param);
            r.setDataset(page);
            r.setMsg("");
    ...
    public ModelAndView add(@PathVariable(required = false) String id) {
        ModelAndView view = new ModelAndView("admin/manage/xfznl/add");
...
/**
    ...
    public Object updateStatus() {
        ...
        try {
            xfznlService.updateStatus(param);
            r.setMsg("修改成功");
        }catch (JSONException e){
            r.setCode(-1);
            r.setMsg(e.getMessage());
    ...
    public Object getPageInformationList() {
        ...
        try {
            ...
            //分页查询
            Page<?> page  = xfznlService.getPageInformationList( type, current, rowcount);
            r.setDataset(page);
            r.setMsg("操作成功");
    ...
    public Object getPageInformationById() {
        ...
        try {
            ...
            Map<String, Object> map =xfznlService.getPageInformationById(ID);
            results.add(map);
