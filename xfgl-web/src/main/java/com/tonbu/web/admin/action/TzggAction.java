...
public class TzggAction {
    ...
    Logger logger = LogManager.getLogger(TzggAction.class.getName());
    ...
    public ModelAndView home() {
        ModelAndView view = new ModelAndView("admin/manage/tzgg/list");
        return view;
    }
    ...
    public Object list() {
        ...
        Page<?> page;
        try {
            page = tzggService.loadList(param);
            r.setDataset(page);
            r.setMsg("");
    ...
    public ModelAndView add(@PathVariable(required = false) String id) {
        ModelAndView view = new ModelAndView("admin/manage/tzgg/add");
    ...
    public Object updateStatus() {
        ...
        try {
            tzggService.updateStatus(param);
            r.setMsg("修改成功");
        } catch (JSONException e) {
            r.setCode(-1);
            r.setMsg(e.getMessage());
    ...
    public Object getPageInformationList() {
        ...
        try {
            ...
            //分页查询
            Page<?> page = tzggService.getPageInformationList(type, current, rowcount);
            r.setDataset(page);
            r.setMsg("操作成功");
    ...
    public Object getPageInformationById() {
        ...
        try {
            ...
            Map<String, Object> map = tzggService.getPageInformationById(ID);
            results.add(map);
