...
import com.tonbu.web.admin.service.XxfbService;
...
public class XxfbAction {

    Logger logger = LogManager.getLogger(XxfbAction.class.getName());
    ...
    public ModelAndView home() {
        ModelAndView view = new ModelAndView("admin/manage/xxfb/list");
        return view;
    }
    ...
    public Object list() {
        ...
        Page<?> page;
        try {
            page =xxfbService.loadList(param);
            r.setDataset(page);
            r.setMsg("");
    ...
    public ModelAndView add(@PathVariable(required = false) String id) {
        ModelAndView view = new ModelAndView("admin/manage/xxfb/add");
...
/**
    ...
    public Object updateStatus() {
        ...
        try {
            xxfbService.updateStatus(param);
            r.setMsg("修改成功");
        }catch (JSONException e){
            r.setCode(-1);
            r.setMsg(e.getMessage());
    ...
    public Object getPageInformationList() {
        ...
        try {
            ...
            //分页查询
            Page<?> page  = xxfbService.getPageInformationList( type, current, rowcount);
            r.setDataset(page);
            r.setMsg("操作成功");
    ...
    public Object getPageInformationById() {
        ...
        try {
            ...
            Map<String, Object> map =xxfbService.getPageInformationById(ID);
            if (map.get("CREATE_SS_ID").equals("1")){
                map.put("DWMC","常州市消防支队");
            }
            results.add(map);
