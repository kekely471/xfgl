...
public class DataSourceConfig {
    ...
    @Bean
    public PlatformTransactionManager thirdlyTransactionManager(@Qualifier("thirdlyDataSource") DataSource dataSource) {
        return new DataSourceTransactionManager(dataSource);
    }


    @Bean(name = "oracleLobHandler")
    public LobHandler oracleLobHandler() {
